...
class ObjectDetection(Node):
    def __init__(self):
        ...
        self.detection_checker = LPFL.StabilityDetector(consec_count=5) # 오작동 시(장애물이 있는데 없다고 할 수 있음) 에러를 핸들링하기 위해 장애물을 연속적으로 몇 번 감지 여부를 확인할지 설정 -> 5번 연속으로 true로 들어오면 최종 true로 판명. 
    ...
    def lidar_callback(self, msg):
        ...
        start_angle = 200  # 원하는 각도 범위의 시작 값
