...
class LidarSensorDataPublisher(Node):
    ...
    def publish_lidar_data(self):
        ...
        try:
            ...
            msg.angle_increment = 2 * np.pi / 360.0  # Angular distance between measurements [rad] -> 분해능
            ...
            msg.range_max = 12.0  # Maximum range value [m] -> 6m가 넘어가면 정확도 떨어짐

            ranges = [float('inf')] * int((msg.angle_max - msg.angle_min) / msg.angle_increment)
            intensities = [0.0] * int((msg.angle_max - msg.angle_min) / msg.angle_increment) #빛의 강도
